...
export default function Applications({ job, applications: initialApplications, flash = {} }) {

  // Create local state for applications
  const [applications, setApplications] = useState(initialApplications);

    const handleStatusChange = (applicationId, newStatus) => {
    // Store previous applications state
    ...
    axios.put(route('employer.jobs.applications.update', { job: job.id, application: applicationId }), {
                    ...
                    >
                        ...
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10">
                            <img
                              ...
                              src={application.user.avatar_url || '/images/placeholder.png'}
                      ...
                      <td className="px-6 py-4">
                        <select
                          ...
                          className={`text-sm rounded-full px-2 py-1 border-gray-300 dark:border-gray-600 focus:border-primary dark:focus:border-primary focus:ring focus:ring-primary/20 ${getStatusColor(
                      ...
                      <td className="px-6 py-4 text-sm">
                        <div className="flex items-center gap-4">
                          <button
                            onClick={() =>
                              (window.location.href = route(
                                'employer.jobs.applications.resume',
                                {
                                  job: job.id,
                          ...
                          <Link
                            href={route('employer.jobs.applications.show', {
                              job: job.id,
                              application: application.id,
                            })}
